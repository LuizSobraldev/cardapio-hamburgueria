...
// Fechar o model quando clicar em fechar
...
// Clicar no botao pra adicionar no carrinho
...
function addToCart(name,price){
    ...
    if(existingItem){
        //Se o item ja existe, aumenta apenas a quantidadde + 1
...
checkoutBtn.addEventListener("click", function(){
    ...
    const phone = "988091484"


    window.open(`https://wa.me/${phone}?text=${message} Endereço: ${adressInput.value.toFixed(2)}`, "_blank")
